...
class ArticlesController extends BaseController
{
    ...
    public function index()
    {
        ...
        $articles = $this->articles->frontGetArticles();
        //dd($articles);
        return view('front.articles.articles', ['articles' => $articles]);
    }
    ...
    {
        $article = $this->articles->frontGetArticle($id, 'comments.user');
        return view('front.articles.article', ['article' => $article]);
