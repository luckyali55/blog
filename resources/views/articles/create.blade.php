    ...
    <div class="panel-group">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                @endif
                    <form class="form-horizontal" action="{{route('articlesave')}}" method="post">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group @if ($errors->has('title')) has-error @endif">
                                ...
                                <div class="col-sm-10">
                                    <input type="title" class="form-control" id="title" name="title" placeholder="Article Title" value="{{ old('title') }}">
